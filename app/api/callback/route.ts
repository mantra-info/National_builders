      ...
      <div style="font-family:sans-serif;max-width:520px;margin:auto;border:1px solid #e5e7eb;border-radius:10px;overflow:hidden">
        ...
        <div style="padding:28px 32px;background:#fff">
          <table style="width:100%;border-collapse:collapse;font-size:0.95rem">
            ...
            <tr style="border-top:1px solid #f3f4f6"><td style="padding:10px 0;color:#6b7280">Email</td><td style="padding:10px 0;font-weight:600;color:#111">${email || "Not provided"}</td></tr>
          </table>
